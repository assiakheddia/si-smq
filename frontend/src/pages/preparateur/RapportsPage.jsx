...
/* ── type / statut maps (backend Document.type / .statut) ── */
const TYPE_LABEL = {
...
const TYPE_COLOR = {
  ...
  charte:            { bg: "#dcfce7", color: "#166534" },
  manuel:            { bg: "#dbeafe", color: "#1e40af" },
...
export default function RapportsPage() {
  ...
  const mapDoc = (d) => ({
    ...
    titre: d.titre,
    type: d.type || "autre",
    typeLabel: TYPE_LABEL[d.type] || "Autre",
    date: d.date_creation ? d.date_creation.split("T")[0] : "—",
    auteur: d.auteur ? `${d.auteur.prenom} ${d.auteur.nom}` : "—",
    statut: STATUT_LABEL[d.statut] || "Brouillon",
  });

  const REPORTS = documents.map(mapDoc);
        ...
        <div className="rap-card" style={{ animationDelay: "0.1s" }}>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              ...
              >
                {["Tous", "Finalisé", "En révision", "Brouillon", "Archivé", "Obsolète"].map((f) => (
